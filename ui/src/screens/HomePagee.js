...
export default function HomePage() {
  ...
  return (
    <div className="flex  h-screen w-screen bg-blue-100 p-5 absolute object-cover w-screen">
      {/* Sidebar */}
      <div className="flex flex-col w-1/4 h-full ">
        <div className="flex flex-col space-y-2 p-4 shadow-lg bg-white top-0 bottom-0 mx-0">
          {/* Accordion */}
      ...
      <div className="flex flex-col w-full px-5 justify-center items-center ">
        {/* Buttons Row */}
        <div className="flex w-full m-1 justify-between absolute  space-x-2.5">
          <Button color="lightBlue" className="mr-0 border-none bottom">Unpaid Involls: </Button>
